...
<div class="nav-top" id="nav-top">
    <div class="w980">   
        <div class="fl">
            ...
            <a href="http://www.94uv.com" target="_blank">有味首页</a>
            <a href="http://www.94uv.com" target="_blank">有味小组</a>
            <a href="http://pai.94uv.com/" target="_blank">有味拍卖</a>
        </div>
        <!--个人信息-->
        <div class="fr">
            ...
            <span class="weixin ico">
                <div><p class="weixinxxcb"><span></span>潇湘晨报</p><p class="weixinxxt"><span></span>xx团</p></div>
            </span>
        </div>
    </div>
</div>
<header class="header clear">
    <div class="w980">
        <h1 class="logo"><a href="index.php" rel="home" title="纸条首页"></a></h1>
    </div>
</header>