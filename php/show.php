    ...
    <div class="main clear">
        ...
        <div id="page-chat" class="ct chat-ct">
            ...
            <div class="operation clear">
                ...
                <a class="btn btn-default fr" href="javascript:;" id="btn-blackuser" data-command="userban" data-value="{uid:'<?php echo $tuser['userid'] ?>',username:'<?php echo $tuser['username'] ?>'}"><i class="fa fa-ban block-ico"></i>屏蔽用户</a>
            </div>
